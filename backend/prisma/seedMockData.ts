// Self-contained mock data for seeding the database

export const plantCategories = ['All', 'Medicinal', 'Herbs', 'Roots'] as const

const ashwagandhaDetail: any = {
  id: 'ashwagandha',
  name: 'Ashwagandha',
...
const simplePlantDetail = (plant: any): any => plant

export const plantDetailsMockData: any[] = [
  ashwagandhaDetail,
  simplePlantDetail({
    id: 'tulsi',
    name: 'Tulsi',
...
export const plantsMockData: any[] = plantDetailsMockData.map(
